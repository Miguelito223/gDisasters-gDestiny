...
function ENT:PlayFadeinSound()
	...
	if category == "EF0" or category == "EF1" or category == "EF2"then
		...
		CreateSoundWave("disasters/nature/tornado/ef0_fadein.mp3", self:GetPos(), "mono", 340/2, {80,120}, 10)
		
	elseif category == "EF3" then
	
		CreateSoundWave("disasters/nature/tornado/ef3_fadein.mp3", self:GetPos(), "mono", 340/2, {80,120}, 10)
	...
	elseif category == "EF6" then
		...
		CreateSoundWave("disasters/nature/tornado/martian_tornado_fadein.mp3", self:GetPos(), "3d", 340/2, {80,120}, 10)
...
function ENT:PlayFadeoutSound()
	...
	if category == "EF0" or category == "EF1" or category == "EF2"then
		...
		CreateSoundWave("disasters/nature/tornado/ef0_fadeout.mp3", self:GetPos(), "3d", 340/2, {80,120}, 10)
...
function ENT:PostShouldFollowPath()
	...
	self:SetPos( self.Path[1] + Vector(0,0,10) )
...
function ENT:SetupMoveType()
	...
	if self.Data.ShouldFollowPath == true then
		...
		if MapPathed()==false then self:Remove() end 
...
function ENT:CreateLoop()
	...
	if category == "EF0" then
		...
		spath      = table.Random( {"disasters/nature/tornado/ef0_loop.wav", "disasters/nature/tornado/ef0_loop2.wav"})
		
	elseif category == "EF1" or category == "EF2" then
		spath      = "disasters/nature/tornado/ef1_loop.wav"
		
	elseif category == "EF3" then
				
		spath      = "disasters/nature/tornado/ef3_loop.wav"	
		
	elseif category == "EF4" then
	
		spath      =  table.Random( {"disasters/nature/tornado/ef4_loop.wav", "disasters/nature/tornado/ef4_loop2.wav"})

	elseif category == "EF5" then
	
		spath      =  table.Random( {"disasters/nature/tornado/ef5_loop.wav", "disasters/nature/tornado/ef5_loop2.wav"})
		
	elseif category == "EF6" then
	
		spath      =  ("disasters/nature/tornado/martian_tornado_loop.wav")

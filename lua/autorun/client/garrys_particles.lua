...
game.AddParticles( "particles/moderate_rairn_effect.pcf" )
...
game.AddParticles( "particles/firenado_hq.pcf")
game.AddParticles( "particles/firenado_hf.pcf")
game.AddParticles( "particles/meteor_explosion_main_ground.pcf")
game.AddParticles( "particles/meteor_explosion_main.pcf")
